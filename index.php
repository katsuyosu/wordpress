    ...
    <div class="findPet__inner inner">
      ...
      <div class="findPet__wrap">
        <ul class="findPet__list">
          ...
          $taxonomys = get_terms($taxonomy_name); //配列に入れる
          if (!is_wp_error($taxonomys) && count($taxonomys)) :
            foreach ($taxonomys as $taxonomy) :

              $term_id = esc_html($taxonomy->term_id);
              $term_idsp = 'cat_type_' . $term_id; //タクソノミーの名前＋タームIDが必要
    ...
    <div class="findStore__inner inner">
      ...
      <div class="findStore__wrap">
        ...
        <div class="findStore__shop">
          <a href="<?php echo get_post_type_archive_link('shop'); ?>/sapporo" class="findStore__link">
            <div class="findStore__name findStore__name--sapporo">札幌店</div>
          </a>
          <a href="<?php echo get_post_type_archive_link('shop'); ?>/miyagi" class="findStore__link">
            <div class="findStore__name findStore__name--miyagi">宮城店</div>
          </a>
          <a href="<?php echo get_post_type_archive_link('shop'); ?>/shinjuku" class="findStore__link">
            <div class="findStore__name findStore__name--shinjuku">新宿店</div>
          </a>
          <a href="<?php echo get_post_type_archive_link('shop'); ?>/ishikawa" class="findStore__link">
            <div class="findStore__name findStore__name--ishikawa">石川店</div>
          </a>
          <a href="<?php echo get_post_type_archive_link('shop'); ?>/umeda" class="findStore__link">
            <div class="findStore__name findStore__name--umeda">梅田店</div>
          </a>
          <a href="<?php echo get_post_type_archive_link('shop'); ?>/shizuoka" class="findStore__link">
            <div class="findStore__name findStore__name--shizuoka">静岡店</div>
          </a>
          <a href="<?php echo get_post_type_archive_link('shop'); ?>/fukuoka" class="findStore__link">
            <div class="findStore__name findStore__name--fukuoka">福岡店</div>
          </a>
          <a href="<?php echo get_post_type_archive_link('shop'); ?>/kagoshima" class="findStore__link">
            <div class="findStore__name findStore__name--kagoshima">鹿児島店</div>
          </a>
        </div>
      </div>
